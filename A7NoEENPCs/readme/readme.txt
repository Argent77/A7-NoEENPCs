...
7. Make Baeloth passive (BG:EE and EET only)
...
8. Make Hexxat passive (BG2:EE and EET only)
   This component prevents Hexxat from initiating a conversation on her own.

9. Make Neera passive (BG:EE, BG2:EE and EET)
...
10. Make Rasaad passive (BG2:EE and EET only)
